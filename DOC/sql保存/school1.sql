...
（三）设立了“吉首大学扶贫助学金”，建立了吉首大学贫困生救助网站；（四）每年提供学生困难补助费几十万元，主要以发放“特别困难补助费”和设立勤工助学岗位等形式，资助校贫困生。' COMMENT '困难生资助办法',
    ...
    `dormitory` varchar(520) DEFAULT '一、本科生四人一间，全部住校内。宿舍配备床铺、衣柜、书桌、电话、网线，自在畅游于理想王国！
...
三、住宿费（三类）：
     ...
     医学部:  1200元/生/年' COMMENT '宿舍',
    `canteen` varchar(2048) DEFAULT '北大的食堂，数目很多，各具特色。
...
华美：位于42楼后，位置比较偏僻。主要经营炒菜，也就是家常菜为主。价格基本合理。' COMMENT '食堂',
    `average_food` varchar(520) DEFAULT '北京大学有学生食堂近10个，种类齐全，可以品尝到全国各地优秀风味。

伙食标准因人而异，平均约350~400元/生/月。' COMMENT '其它',
    `admission_information` varchar(200) DEFAULT '请登录吉首大学招生信息网http://jsuzs.jysd.com/' COMMENT '往年录取信息',
