...
import com.heyufei.service.DepartmentTypeService;
...
public class DepartmentTypeController {
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		Page<DepartmentType> pageList = departmentTypeService.findSearch(searchMap, page, size);
		return  new Result(true,StatusCode.OK,"查询成功",  new PageResult<DepartmentType>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return new Result(true,StatusCode.OK,"查询成功",departmentTypeService.findSearch(searchMap));
    }
