...
import nuxt_plugin_vueinfinitescroll_8d6badb0 from 'nuxt_plugin_vueinfinitescroll_8d6badb0' // Source: ..\\plugins\\vue-infinite-scroll (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"高考志愿平台","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"{{escape description }}"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
